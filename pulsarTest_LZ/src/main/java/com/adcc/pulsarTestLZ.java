...
public class pulsarTestLZ {
    private static final Logger logger = Logger.getLogger(String.valueOf(pulsarTestLZ.class));
...
//        String sendMsg = readToString(fliePath);
        ...
        FlightAutoslot flightAutoslot1 = new FlightAutoslot((long)902325023);
        FlightAutoslot flightAutoslot2 = new FlightAutoslot((long)902325024);
        flightAutoslot1.setCto("202003251246");
        flightAutoslot2.setCto("202003251345");
