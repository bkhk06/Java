...
public class BookController {
    ...
    public void findAll(){
        ...
        Page<Book> page = (Page<Book>) bookService.getBookByPage(pageRequest);
       System.out.println("总页数： "+page.getTotalPages());
       System.out.println("总纪录数： "+page.getTotalElements());
       System.out.println("查询结果："+page.getContent());
       System.out.println("当前页数："+(page.getNumber()+1));
       System.out.println("当前页纪录数： "+page.getNumberOfElements());
       System.out.println("每页纪录数："+page.getSize());
    }
    ...
    public void search(){
        ...
        List<Book> bs4 = bookService.getBooksByPriceGreatedThan(30F);
