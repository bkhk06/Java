...
public class Send {
	...
	//private static final String url = "failover:(ws://192.168.13.253:61614/stomp,ws://192.168.11.68:61614/stomp";
	private static final String QUEUE_NAME = "G1Queue";
	...
	public void sendMessage() throws JMSException {
		...
		try {
			...
			int i = 0;
			do {
				msg = "The " + QUEUE_NAME + i + "th " + "msg_" + new Random();
			...
			try {
				...
				if (session != null) {
					session.close();
					System.out.println("Session was closed successfully~");
				}
